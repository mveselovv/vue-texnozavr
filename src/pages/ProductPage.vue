<template>
  <main class="content container content__preloader" v-if="productLoading">
    <div class="content__preloader--img">
      <div></div>
      <div></div>
      <div></div>
      <div></div>
  ...
  <main class="content container content__loader--error" v-else-if="!productData">Произошла ошибка при загрузке товара
    :(
          ...
          <form class="form" action="#" method="POST" @submit.prevent="addToCart">
            ...
            <div class="item__row">
              <div class="form__counter">
                <button type="button" aria-label="Убрать товар" @click.prevent="decrementButton">
                  <svg width="12" height="12" fill="currentColor">
                    <use xlink:href="#icon-minus"></use>
                  </svg>
                </button>
                <input type="text" v-model.number="productAmount">
                <button type="button" aria-label="`Добавить товар`" @click.prevent="incrementButton">
                  <svg width="12" height="12" fill="currentColor">
              ...
              <div class="form__counter--message">
                <div v-show="productAdded">Товар добавлен в корзину</div>
                <div v-show="productAddSending"><div class="lds-ring"><div></div><div></div><div></div><div></div></div>
                Добавляем товары в корзину...</div>
              </div>
            </div>
          </form>
        </div>
